...
# -*- encoding: utf-8 -*-
"""
@Time    : 2019-02-27 10:30
@Author  : red
@Site    : 
@File    : filter_tags_util.py
@Software: PyCharm
"""
import re
...
if __name__ == '__main__':
    ...
    filters = FilterTag()
    print(filters.stripTagSimple(
        '<span class="url-icon"><img alt=[憧憬] src="//h5.sinaimg.cn/m/emoticon/icon/default/d_xingxingyan-34ecaee809.png" style="width:1em; height:1em;" /></span>好A！！锁了'))
