...
if __name__ == '__main__':
    ...
    # article存储路径
    article_path = "/Users/red/Desktop/temp/news/data/tianya_data/article_txt"
    doc.path_exists(article_path)
    # article_comment存储路径
    article_comment_path = "/Users/red/Desktop/temp/news/data/tianya_data/article_comment_txt"
    ...
    xlwt_util.save_xlwt(4, 'sheet1', title, excel, '/Users/red/Desktop/temp/news/data/tianya_data/index.xls')
